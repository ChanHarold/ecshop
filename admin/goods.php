...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $goods_long = isset($_POST['goods_long'])? $_POST['goods_long'] : '0';
    $goods_wide =  isset($_POST['goods_Wide'])?  $_POST['goods_Wide'] : '0';
    $goods_high = isset($_POST['goods_High'])? $_POST['goods_High'] : '0';
    /* 入库 */
    if ($is_insert)
    {
        if ($code == '')
        {
            ...
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, packing_list, customer_service, add_time, last_update, goods_type, rank_integral, suppliers_id,other_long,other_wide,other_high)".
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '$_POST[packing_list]', '$_POST[customer_service]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id','$goods_long','$goods_wide','$goods_high')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, packing_list, customer_service,add_time, last_update, goods_type, extension_code, rank_integral,other_long,other_wide,other_high)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '$_POST[packing_list]', '$_POST[customer_service]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral','$goods_long','$goods_wide','$goods_high')";
        }
    }
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
                ...
                "other_long=$goods_long,".
                "other_wide=$goods_wide,".
                "other_high=$goods_high,";
    ...
    if ((isset($_POST['attr_id_list']) && isset($_POST['attr_value_list']) && isset($_POST['attr_img_id'])) || (empty($_POST['attr_id_list']) && empty($_POST['attr_value_list'])  && empty($_POST['attr_img_id'])))/*模板堂修改 end by zhouH*/
    {
        ...
        foreach ($goods_attr_list as $attr_id => $attr_value_list)
        {
            foreach ($attr_value_list as $attr_value => $info)
            {
                ...
                {
					/*模板堂修改 start by zhouH*/
                    $sql = "INSERT INTO " .$ecs->table('goods_attr'). " (attr_id, goods_id, attr_value, attr_price ,img_id,other_long,other_wide,other_high)".
                            "VALUES ('$attr_id', '$goods_id', '$attr_value', '$info[attr_price]' ,'$info[img_id]','$info[other_long]','$info[other_wide]','$info[other_high]')";
					/*模板堂修改 end by zhouH*/
                }
